...
const carriersData = [
    ...
    { id: 4, type: "print", name: "Постер А4", desc: "Информационный постер формата А4 (210×297 мм). Предназначен для размещения как внутри магазина,так и вне для привлечения покупателей. Использованы основные шрифты CoderPro и Benzin-medium, а также фирменный фотостиль. ", images: ["images/poster_shina.png", "images/poster-a4-2.jpg"] },
