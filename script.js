...
const carriersData = [
    ...
    { id: 3, type: "pack", name: "Ароматизатор", desc: "Автомобильный ароматизатор из плотного картона с односторонней печатью. Размер 120x80 мм. Крепится на зеркало заднего вида с помощью ленты. Используется как промо-сувенир.", images: ["images/air-freshener-1.png", "images/air-freshener.svg"] },
    { id: 4, type: "print", name: "Постер А4", desc: "Информационный постер формата А4 (210×297 мм). Предназначен для размещения как внутри магазина,так и вне для привлечения покупателей. Использованы основные шрифты CoderPro и Benzin-medium, а также фирменный фотостиль. ", images: ["images/poster_shina1.png", "images/poster-a4-2.jpg"] },
