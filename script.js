...
const carriersData = [
    { id: 0, type: "print", name: "Блокнот", desc: "Блокнот формата А5 с твёрдой обложкой и кольцами. Используется для корпоративных записей и подарков. На обложку нанесены логотип, текущая дата, фирменные элементы, а также мотивоционная цитата.", images: ["images/notebook-1.png", "images/notebook-2.svg"] },
    ...
    { id: 2, type: "print", name: "Визитка", desc: "Двусторонняя визитная карточка размером 90×50мм. На визитке используется модифицированный логотип и фирменная графика. Содержит информацию о времени работы, контактные данные, сайт и qr-код.", images: ["images/business-card-1.png", "images/business-card-2.svg"] },
    ...
    { id: 6, type: "print", name: "Конверт", desc: "Евроконверт с подкладкой размерами 220*110мм. На обратную сторону нанесён модифицированный логотип цветом и контактная информация, выполнена минимальным кеглем в белом цвете.", images: ["images/envelope.png", "images/envelope-2.svg"] },
    { id: 7, type: "pack", name: "Папка", desc: "Папка-регистратор А4.", images: ["images/folder-1.png", "images/folder-2.jpg"] },
    { id: 8, type: "pack", name: "Лента", desc: "Упаковочная лента размером 55мм*66м на фирменном синем фоне. Вдоль всей ленты по центру располагаются фирменный знак и текстовый логотип цветом, повторяясь с равным шагом. Никакой дополнительной графики - только чистая типографика и цвет. Лента остаётся узнаваемой даже при неровном обрыве.", images: ["images/ribbon-1.png", "images/ribbon-2.svg"] },
    { id: 9, type: "pack", name: "Форма", desc: "Футболка или поло синего цвета. На спине, в верхней части, располагается вышитый логотип - знак и текстовое название. Цвет вышивки - E9F055. Без дополнительной графики. Логотип не спорит с одеждой, а работает как акцент на естественной зоне фокуса.", images: ["images/t-shirt1.png", "images/shirt.svg"] },
    ...
    { id: 11, type: "outdoor", name: "Морской контейнер", desc: "Оклейка контейнера размером 12000*2800 мм несет на себе название и  модифицированный логотип магазина и слоган, а также информацию по грузу. Контейнер представлен в черном цвете и использует только фирменные цвета. В данном случае модифицированный логотип выступает в роли графического элемента.", images: ["images/container-1.png", "images/container-2.png"] },
    { id: 12, type: "pack", name: "Кепка", desc: "Бейсболка с вышивкой для сотрудников синего цвета. Спереди - вышитое название компании. Сзади, на этикетке, - вышит маленький логотип без текста. Два простых акцента работают как пара: название представляет, знак закрепляет.", images: ["images/cap-1.png", "images/cap.svg"] },
    ...
    { id: 14, type: "outdoor", name: "Билборд", desc: "Рекламный щит 3000×6000мм. В левой части расположена комбинация из фирменного элемента и графики с рекламой. В правой части расположены логотип, qr-код, ниже расположена доп. информация - телефон, адрес, сайт.", images: ["images/billboard-1.png", "images/billboard-2.svg"] },
    { id: 15, type: "print", name: "Плакат", desc: "Плакат формата А2 (420×594 мм) с белым фоном. Основной визуальный акцент в центре - половина машины, обработанная с наложением Difference (ч/б, с едва заметным зерном). Поверх изображения - крупный логотип. В правом нижнем углу qr-код, ведущий на сайт магазина.", images: ["images/poster-a2-1.png", "images/poster-a2-2.svg"] },
    { id: 16, type: "outdoor", name: "Указатель", desc: "Указатель для физической точки магазина. Выполнен с использованием фирменных цветов, шрифта Benzin-medium для заголовка отделов, а шрифт CodecPro для основной информации. Для визуального определения отдела в левой части указателя располагается фирменный элемент с инструментом.", images: ["images/znak.png", "images/znak.svg"] }
];
