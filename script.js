...
const carriersData = [
    { id: 0, type: "print", name: "Блокнот", desc: "Блокнот формата А5 с твёрдой обложкой и кольцами. Используется для корпоративных записей и подарков.", images: ["images/notebook-1.png", "images/notebook-2.svg"] },
